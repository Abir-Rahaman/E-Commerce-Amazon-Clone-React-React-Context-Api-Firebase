...
const Header = () => {
    return (
        <div className='flex items-center justify-around py-6 bg-slate-900'>
          ...
          <p> <input style={{width:'1200px'}} type="text" placeholder="Search Your Needy Components" class="text-red-500 outline-none border-orange-500 border-4 px-4 mr-6 py-2 bg-transparent rounded-full" /> </p> 
          <button className='text-2xl px-4 py-3 bg-orange-500 rounded-full text-white'> <BiSearchAlt2/> </button>
